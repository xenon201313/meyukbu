...
메력서 작성자는 `익명 체온 설문 링크 만들기`로 7일 안에 한 번 사용할 수 있는 링크를 발급할 수 있습니다. 실제 함께한 파티원은 닉네임, 메력서 주소, 연락처를 입력하지 않고 세 문항에 답합니다.
...
- 메숭이 체온은 이력서 미리보기와 1080×1350 PNG의 핵심 항목으로 표시됩니다. 설문이 반영된 뒤에는 같은 이미지 URL도 최신 익명 집계값으로 다시 렌더링됩니다. 자동 매칭·합격 판단에는 사용하지 않습니다.
