    ...
    <main className="resume-shell">
      ...
      <div className="mx-auto max-w-3xl px-5 py-10 sm:px-8">
        ...
        <div className="resume-paper mt-7 space-y-6 rounded-2xl p-6 leading-7 text-[#52606d] sm:p-8">
          ...
          <p>
            메숭이 체온 동행 기록을 남기면 평가자의 공개 메력서 링크, 캐릭터명·월드·직업, 선택한 동행 태그와
            작성 시각이 대상 메력서의 검증 페이지에 공개됩니다. 별점, 온도 수치, 자유 댓글은 수집하지
            않습니다.
          </p>
          <p>
            동행 확인 링크는 한 번만 사용할 수 있으며 7일 뒤 만료됩니다. 링크 원문은 저장하지 않고 해시만
            보관합니다. 서비스는 실제 파티 참여나 게임 계정의 소유권을 보증하지 않습니다.
          </p>
        </div>
      </div>
    </main>
