    ...
    <main className="resume-shell">
      ...
      <div className="mx-auto max-w-3xl px-5 py-10 sm:px-8">
        ...
        <div className="resume-paper mt-7 space-y-6 rounded-2xl p-6 leading-7 text-[#52606d] sm:p-8">
          ...
          <p>
            API 데이터와 작성 내용은 서로 다른 출처 배지로 표시됩니다. 오래된 API 데이터는 stale 또는 expired
            상태로 안내하며, 갱신 전까지 일부 공개가 제한될 수 있습니다.
          </p>
          <p>
            메숭이 체온은 점수·별점·순위가 아닌 기명 동행 태그 기록입니다. 실제 파티 참여나 게임 계정 소유권을
            서비스가 인증하거나 보증하지 않으며, 익명 평판·부정 평가·블랙리스트 기능은 제공하지 않습니다.
          </p>
        </div>
      </div>
    </main>
